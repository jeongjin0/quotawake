...
if [[ "${SCENARIO}" == "normal-launch" ]]; then
  ...
  rg -q '"statusItemTitle" : ""' "${EVIDENCE_DIR}/normal-launch.json"
  rg -q '"statusItemHasImage" : true' "${EVIDENCE_DIR}/normal-launch.json"
  rg -q '"statusItemImageIsTemplate" : true' "${EVIDENCE_DIR}/normal-launch.json"
  rg -q '"statusItemImageWidth" : 21' "${EVIDENCE_DIR}/normal-launch.json"
  rg -q '"statusItemImageHeight" : 21' "${EVIDENCE_DIR}/normal-launch.json"
