...
struct NormalLaunchQAConfig {
    ...
    func writeEvidence(
        ...
        statusButtonFrame: NSRect,
        statusButtonWindowFrame: NSRect,
        statusButtonIsHidden: Bool,
        statusButtonIsEnabled: Bool,
        popoverShown: Bool,
        popoverSize: NSSize,
        ...
        let payload: [String: Any] = [
            ...
            "statusButtonFrame": NSStringFromRect(statusButtonFrame),
            "statusButtonWindowFrame": NSStringFromRect(statusButtonWindowFrame),
            "statusButtonIsHidden": statusButtonIsHidden,
            "statusButtonIsEnabled": statusButtonIsEnabled,
